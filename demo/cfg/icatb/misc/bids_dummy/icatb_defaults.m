...
COMPONENT_NAMING = '_compo_ce_nent_ica_';

if (~strcmpi(modalityType, 'smri'))
    TIMECOURSE_NAMING = '_tim_ce_ecourses_ica_';
else
    TIMECOURSE_NAMING = '_loa_ce_ding_coeff_';
end

%% Naming Convention Output Files( Matlab Format)
PARAMETER_INFO_MAT_FILE = '_ica_parameter_info';
DATA_REDUCTION_MAT_FILE = '_pca_r_ce';
ICA_MAT_FILE = '_ica_ce';
BACK_RECONSTRUCTION_MAT_FILE = '_ica_br_ce';
CALIBRATE_MAT_FILE = '_ica_c_ce';
